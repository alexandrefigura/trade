#!/usr/bin/env python3
"""
Script limpo para diagnosticar e corrigir importações
"""
import os
import ast
...
def diagnose_system():
    """Diagnostica o sistema e cria versão funcional"""
    print("🔍 DIAGNOSTICANDO SISTEMA DE TRADING")
    print("=" * 60)
    
    # Verificar estrutura
    if not os.path.exists('trade_system'):
        print("❌ Diretório trade_system não encontrado!")
        return
...
def create_working_integrated_system(found_classes):
    ...
    print("\n\n📝 Criando sistema integrado funcional...")
...
'''
    ...
    print("✅ integrated_trading_clean.py criado!")
...
if __name__ == "__main__":
    ...
    print("   - Funciona mesmo se alguns módulos falharem")
